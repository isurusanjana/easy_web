                                ...
                                <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                                    <div class="mb-4 p-0">
                                        <a href="index.html" class="auth-logo">
                                            <img src="{{ 'backend/assets/images/logo-dark.png' }}" alt="logo-dark" class="mx-auto" height="28" />
                                        </a>
                                    </div>
                                    ...
                                    <div class="pt-0">
                                        <form method="POST" action="{{ route('register') }}" class="my-4">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input class="form-control" type="password" required="" id="password_confirmation" name="password_confirmation" placeholder="Enter your password" autocomplete="new-password">
                                            </div>
                        ...
                        <div class="account-page-bg p-md-5 p-4">
                            <div class="text-center">
                                ...
                                <div class="auth-image">
                                    <img src="{{ 'backend/assets/' }}images/authentication.svg" class="mx-auto img-fluid"  alt="images">
                                </div>
                            </div>
                        </div>
                    </div>
